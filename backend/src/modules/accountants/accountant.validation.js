...
export const createAccountantValidation = [
  body("fullName")
...
export const updateAccountantValidation = [
...
export const updateAccountantStatusValidation = [
  body("status")
    .notEmpty().withMessage("Status is required")
    .isIn(["active", "inactive", "resigned"])
    .withMessage("Status must be: active, inactive, or resigned"),
];
