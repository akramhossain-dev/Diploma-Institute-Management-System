...
export default function AdminNotificationsPage() {
  ...
  if (isLoading) {
    return (
      <PageContainer>
        <SectionHeader title="System Notifications" description="Loading notifications panel..." />
  ...
  if (isError) {
    return (
      <PageContainer>
        <SectionHeader title="System Notifications" description="Administrator alerts inbox." />
        <ErrorState message="Failed to fetch admin notifications. Please verify database connectivity." onRetry={refetch} />
      </PageContainer>
    );
  }
  ...
  return (
    <PageContainer>
      <SectionHeader
        ...
        description="Monitor system-wide operational alerts, pending admissions, job completions, and security warnings."
        action={
          unreadCount > 0 && (
            <Button
              variant="outline"
      ...
      {filteredNotifications.length === 0 ? (
        <EmptyState
          ...
          description={
            statusFilter === 'unread'
              ? "All caught up! You don't have any unread system alerts."
              : 'Your system notifications inbox is empty.'
          }
      ...
      <ConfirmDialog
        ...
        description="Are you sure you want to dismiss all pending system notifications? This action cannot be undone."
        onConfirm={async () => {
          await markAllAsRead();
        }}
      />
