...
export default function TeacherNotificationsPage() {
  ...
  if (isLoading) {
    return (
      <PageContainer>
        <SectionHeader title="Staff Notifications" description="Loading portal alerts..." />
  ...
  if (isError) {
    return (
      <PageContainer>
        <SectionHeader title="Staff Notifications" description="Faculty alerts inbox." />
        <ErrorState message="Failed to fetch teacher notifications. Please verify network connectivity." onRetry={refetch} />
      </PageContainer>
    );
  }
  ...
  return (
    <PageContainer>
      <SectionHeader
        ...
        description="Monitor teacher-specific portal alerts, exam scheduling deadlines, missing attendances, and department circulars."
        action={
          unreadCount > 0 && (
            <Button
              variant="outline"
      ...
      {filteredNotifications.length === 0 ? (
        <EmptyState
          ...
          description={
            statusFilter === 'unread'
              ? 'Excellent! You have read all notifications in your faculty portal.'
              : 'You do not have any notices in your staff alert center.'
          }
      ...
      <ConfirmDialog
        ...
        description="Are you sure you want to dismiss all pending staff alerts? This action cannot be undone."
        onConfirm={async () => {
          await markAllAsRead();
        }}
      />
